...
function useAudio() {
  ...
  useEffect(() => {
    song1.current = new Audio("/audio/song1.mp3");
    song2.current = new Audio("/audio/song2.mp3");
...
// ---------------- Scenes ----------------
const HERO_PHOTO = "https://images.unsplash.com/photo-1531415074968-036ba1b575da?w=900&q=80";
const MEMORIES = [
  { over: "OVER 1", title: "Childhood", img: "https://images.unsplash.com/photo-1503454537195-1dcabb73ffb9?w=900&q=80", text: "Where it all began — laughter, scraped knees, and a million little adventures." },
  { over: "OVER 2", title: "School Life", img: "https://images.unsplash.com/photo-1503676260728-1c00da094a0b?w=900&q=80", text: "Classroom legends, lunchbox swaps, and the friends who became family." },
  { over: "OVER 3", title: "College Life", img: "https://images.unsplash.com/photo-1523240795612-9a054b0db644?w=900&q=80", text: "Late nights, big dreams, and the chapters that shaped who you became." },
  { over: "OVER 4", title: "Cricket Journey", img: "https://images.unsplash.com/photo-1540747913346-19e32dc3e97e?w=900&q=80", text: "Every six, every wicket, every roar — the innings that defined a legend." },
];
const GALLERY = [
  { img: "https://images.unsplash.com/photo-1517649763962-0c623066013b?w=900&q=80", h: "tall" },
  { img: "https://images.unsplash.com/photo-1531415074968-036ba1b575da?w=900&q=80", h: "short" },
  { img: "https://images.unsplash.com/photo-1593341646782-e0b495cff86d?w=900&q=80", h: "short" },
  { img: "https://images.unsplash.com/photo-1540747913346-19e32dc3e97e?w=900&q=80", h: "tall" },
  { img: "https://images.unsplash.com/photo-1607627000458-210e8d2bdb1d?w=900&q=80", h: "short" },
  { img: "https://images.unsplash.com/photo-1624280157150-4d1ed8632989?w=900&q=80", h: "tall" },
];
const LOCKERS = [
  ...
  "https://images.unsplash.com/photo-1607627000458-210e8d2bdb1d?w=900&q=80",
  "https://images.unsplash.com/photo-1624280157150-4d1ed8632989?w=900&q=80",
];
          ...
          {reveal && (
            ...
            >
              <div className="relative inline-block">
                ...
                <h1 className="relative font-display text-6xl sm:text-7xl font-black text-shimmer">ARJUN</h1>
              </div>
              <div className="font-display text-sm tracking-[0.4em] text-[#FFD700]/90">JERSEY #18</div>
      ...
      <div className="relative min-h-[100dvh] flex flex-col items-center justify-start px-4 py-8 gap-4">
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <div className="relative w-full aspect-[4/5] golden-frame">
              <img src={m.img} alt={m.title} className="h-full w-full object-cover rounded-[1.35rem]" />
            </div>
      ...
      <div className="relative min-h-[100dvh] px-4 py-8 flex flex-col items-center gap-5">
        ...
        <div className="w-full max-w-md glass-panel p-4">
          ...
          <div className="mt-2 flex items-center justify-between">
            <div>
              <div className="font-display text-lg">Arjun #18</div>
